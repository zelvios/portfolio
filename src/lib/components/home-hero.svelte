<script lang="ts">
  ...
  let { isTransitioning, isMounted, gradientActive }: Props = $props()
</script>
...
>
  ...
  >
    <div
      ...
      {isMounted ? 'animate-line-reveal-top' : 'opacity-0'} {gradientActive
        ? 'opacity-0'
        : 'opacity-15'}"
    ></div>
    ...
    <div
      ...
      {isMounted ? 'animate-line-reveal-bottom' : 'opacity-0'} {gradientActive
        ? 'opacity-0'
        : 'opacity-15'}"
    ></div>
  </div>
